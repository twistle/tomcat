...
default['tomcat']['keystore_file_dir'] = nil # by default will be set to config dir below - but can be changed
...
default['tomcat']['keystore_file_dir'] = default['tomcat']['config_dir']
